...
option = st.sidebar.selectbox(
     'Which Dashboard?',
     ('Twitter', 'Wallstreetbets', 'Stocktwits', 'Chart', 'Pattern'), 3)

st.header(option)


users = ['traderstewie','the_chart_life','canuck2usa','sunrisetrader','tmltrader']
...
if option == 'Chart':
    symbol = st.sidebar.text_input("Symbol", value='TARO', max_chars=None, key=None, type='default')
